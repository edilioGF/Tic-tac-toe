...
lblHost = tk.Label(infoFrame, text = "Address: X.X.X.X")
lblHost.pack(side=tk.LEFT)
lblPort = tk.Label(infoFrame, text = "Port:XXXX")
lblPort.pack(side=tk.LEFT)
infoFrame.pack(side=tk.TOP, pady=(5, 0))

ipFrame = tk.Frame(window)
inp_lbl_ip = tk.Label(ipFrame, text = "Ip:")
inp_lbl_ip.pack(side=tk.LEFT)
inp_ip = tk.Entry(ipFrame)
inp_ip.pack(side=tk.LEFT)
ipFrame.pack(side=tk.TOP, pady=(5, 0))

portFrame = tk.Frame(window)
inp_lbl_port = tk.Label(portFrame, text = "Port:")
inp_lbl_port.pack(side=tk.LEFT)
inp_port = tk.Entry(portFrame)
inp_port.pack(side=tk.LEFT)
portFrame.pack(side=tk.TOP, pady=(5, 0))
